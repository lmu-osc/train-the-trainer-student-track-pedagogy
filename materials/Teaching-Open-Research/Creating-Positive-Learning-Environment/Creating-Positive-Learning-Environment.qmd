...
[Click here to see the materials in full screen](Creating-Positive-Learning-Environment-slides.qmd)

```{=html}
<iframe class="slide-deck" src="Creating-Positive-Learning-Environment-slides.html" height="420" width="747" style="border: 1px solid #2e3846;"></iframe>
```
...
<!-- download as pdf -->
<a href="../../../docs/materials/Teaching-Open-Research/Creating-Positive-Learning-Environment/Creating-Positive-Learning-Environment-slides.pdf"
   download="Creating-Positive-Learning-Environment-slides.pdf"
