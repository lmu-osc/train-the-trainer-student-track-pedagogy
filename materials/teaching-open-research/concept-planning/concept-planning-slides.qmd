...
::: {.notes}
**Presenter Notes**: Next question when planniung an event on Open Research: what do you think are some initial **points to consider** when you **plan** an **event on Open Research**? An event could be a workshop, course, lecture, seminar, talk etc. Take three minutes to collect your thoughts.
...
![](images/03_journey.png){fig-align="center" fig-alt="icon depiciting a starting point and end point connected by a line"}
