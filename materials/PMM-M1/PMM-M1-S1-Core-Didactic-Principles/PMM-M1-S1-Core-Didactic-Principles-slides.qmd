...
*EDIT I feel more confident that I can pass on my knowledge of open research to my learners using evidence-based didactic frameworks*
...
- Hierarchy learning goals
- Formulating concrete learning goals
</div>
...
Catherine Twomey Fosnot (Ed.). (2013). Constructivism: Theory, Perspectives, and Practice
:::
...
**Constructivism**: Learning is not passively received, but **actively built and shaped** by prior knowledge and the learning context (Fosnot, 2013).
...
::: {.notes}
**Presenter Notes**: With increasing experience level, we move from one type of learner and mental model to another. Simplified, you could look at the types ot learners in terms no novice, competent practicioner, and expert. 
...
Pick another topic from open research. **Sketch out** the mental model of a novice in comparison to a competent practitioner and an expert and **provide concrete examples** of how the organisation of knowledge differs among these three types of learners. 
...
Can you identify things that would help you with **organizing your knowledge** within a mental model?
...
structures
- **Make connections** to concepts **explicit**
  - Encourage learners to make these connections **themselves** (sorting tasks, concept maps)
- Monitor learners’ work for problems in their knowledge organisation ADD EXAMPLE
...
## Practical activity - EDIT

| Learning goals (according to Bloom's taxonomy) | Assessment type |
|-----------------------------|------------------|
| A: *Create* a reproducible research pipeline | 1: Hand in a reflective essay on Open Science ethics |
| B: *Understand* ethical implications of open access | 2: Generate a GitHub project and add a project wiki |
| C: *Analyze* reproducibility issues in published studies | 3: Hand in a peer review of a report on open materials |
| D: *Evaluate* transparency in empirical research | 4: Hand in a data management plan (DMP) |
| E: *Apply* FAIR data principles to a dataset | 5: Write a critical review of an open dataset/paper |

---

## Practical activity - possible solutions

| Field | Learning Goal (Bloom Level) | Assessment Type |
|------|----------------------------|-----------------|
| Psychology | *Analyze* reproducibility issues in published studies | Critical review of an open dataset/paper |
| Biology | *Apply* FAIR data principles to a dataset | Data management plan (DMP) |
| Computer Science | *Create* a reproducible research pipeline | GitHub project with documentation |
| Economics | *Evaluate* transparency in empirical research | Peer review report using open materials |
| Humanities | *Understand* ethical implications of open access | Reflective essay |
...
**Instructor Notes**: Example: Learning objective = conducting an anamnestic interview with a patient. Teaching activites = role plays. Assessment task = Anamnestic interview with fake/real patient. 
:::
