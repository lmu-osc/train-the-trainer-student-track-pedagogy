...
- [ ] check with day 1 outline google doc if all points were ccovered and if outline matches
- [ ] sort out presenter notes
- [ ] sort out instructor notes
- [ ] sort out accessibility tips
- [ ] sort out references and credit
- [ ] reformat and use callout boxes? Or conditional formatting?
...
c. I have basic understanding and sometimes implement it in my teaching.
...
- **Evaluate** the match between learning goals and assessment types
- **Formulate** learning objectives using real-world examples and following the principle of constructive alignment
:::
...
::: {.notes}
**Presenter Notes**: What is learning to you? How would you define it? What expectations or assumptions come with it?
...
**Sketch out** the mental model of a novice in comparison to a competent practitioner and an expert and **provide concrete examples** of how the organisation of knowledge differs among these three types of learners. 
...
- Clearly **lay out expectations or goals** for a session
...
::: {.notes}
**Presenter Notes**: For this next exercise, I would like for you to match the assessment type with a given learning goal. We will learn more about learning goals and how to formulate them later. For now, focus on the alignment aspect: does the learning goal match with the assessment type?
:::
...
::: {.notes}
**Instructor Notes**: Ask for solutions. Solutions are:
...
::: {.notes}
**Presenter Notes**: We are coming to another core didatic principle besides prior knowledge, constructivism, mental models and constructive alignment, namely setting learning goals. 
:::
...
- *Example*: 
  - Learning goal: Students will be able to analyze the causes of climate change and evaluate possible solutions. 
  - Teaching activity: Evaluation of different possible solutions.
  - Assessment task: Group presentation and discussion in class. 

::: {.notes}
**Presenter Notes**: The cognitive domain went through numerous revisions before a finalized version was published (Bloom 1956).
...
- Difficult to measure directly, but can be assessed through observable behaviours (e.g., appreciation, showing commitment, awareness of nuances)

- *Example*:
  - Learning goal: Students will actively engage with opposing viewpoints by asking clarifying questions and incorporating at least one alternative perspective into their own arguments.”
  - Teaching activity: Arguing the opposing viewpoint in a panel discussion
  - Assessment task: Writing a reflection essay incorporating and reflecting on the arguments discussed in class
...
- *Example*:
  - Learners will accurately perform CPR using correct hand placement and rhythm. 
  - Teaching activity: Physical execution of CPR on mannequins with immediate feedback
  - Assessment task: Each learner performs CPR on a mannequin in a simulated emergency scenario (1-2 minutes).
...
## Learning goals within learning domains: Overview
...
Learning objectives can be assigned to different taxonomy levels. Taxonomies serve to organise learning objectives. They help to structure the diversity of learning objectives hierarchically according to logical criteria. They are very useful for monitoring learning objectives. The best-known taxonomy is that of BLOOM.
...
You are tasked to design a course module on Open Research practices and would like to include preregistration, open data and open access publishing. The learning goals for each learning domain are:

- Cognitive: Learners will be able to compare different open access publishing models and assess their advantages and limitations.

- Affective: 

- Psychomotor: Learners will be able to apply an open license (e.g., Creative Commons) correctly to an open data set.

For each learning goal, design one assessment task, including an assessment method (checklist, scoring rubric etc.) and one observable metric of successfully achieving the learning goal.
...
## Why use Bloom's taxonomy in your teaching?
...
- To enhance higher-order thinking (e.g., critical thinking) while improving metacognition, clarifying goals, and revealing misconceptions
:::
...
Example: A learning goal for this session was XXXX: 

::: {.notes}
**Presenter Notes**:

**Instructor Notes**: Pick a learning goal from previous examples or collect learning goals interactively. Examine learning goals more closely in the group and discuss what could be a suitable learning goal and why/why not. Focus on what verbs are being used. 
:::
...
3. Using Bloom's taxonomy, formulate three learning goals and assessment methods that match the content and the teaching activities of the tutorial.  
Which level of Bloom's taxonomy are you at and which domain are you targeting?
...
**How comfortable do you feel in formulating learning goals using Bloom's taxonomy? (1 = not confident at all, 5 = extremely confident**
...
## Constructing knowledge - where to put this slide?
