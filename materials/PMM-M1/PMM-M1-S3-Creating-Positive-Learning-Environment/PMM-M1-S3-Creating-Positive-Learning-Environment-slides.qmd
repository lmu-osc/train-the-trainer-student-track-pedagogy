...
**Instructor Notes**: <br>
- **Aim**: The pre-session survey serves to examine learners' prior knowledge about the session's topic.
...
![](images/08-small-talk.png){width=70% fig-alt="icon showing two people making small talk with each other"}
...
![](images/04-gesticulating.jpeg){width=80% fig-alt="photo of Italian astronaut Samantha Cristoforetti at a press conference in Milan, using her hands to get across a point."}
...
![](images/12_growth_mindset.png){width=80% fig-alt="icon with a purple lightbulb and roots to represent a growth mindset"}
...
![](images/01-when-a-flower-doesnt-bloom.jpg){width=100% fig-align="center"}
