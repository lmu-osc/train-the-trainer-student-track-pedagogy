...
## Before we start: Survey time! EDIT
...
**Activity**:
<br>
**What *can you do* to create a positive learning environment through your attitude to your (Open Science) learners?**
...
::: {.notes}
**Presenter Notes**: What do you think are key aspects of a positive attitude towards your audience? Collect on paper and then try to sort into verbal strategies, body language strategies and methods.
...
## Attitudes towards your audience: Verbal strategies
...
::: {.notes}
**Presenter Notes**: Form groups of three, one is the learner, one the instructor practicing the active listening, one the observer. The learner talks for approx. 2 minutes, then discuss as a group what you noticed.
...
- Use different **visualization methods/tools**
...
**Collect some introductory activities that you use in your teaching on OS or have seen in other OS teaching events you attended**.
</div>
...
::: footer
Laura Carter [https://zenodo.org/records/18905547](https://zenodo.org/records/18905547)
:::
...
Example: When discussing the benefits of open science, instead of using only biomedical research examples, compare practices across several disciplines:
...
Using examples from different fields demonstrates that the principles of openness—such as transparency, sharing, reproducibility, and reuse—are broadly applicable, even though their implementation differs by discipline.

You can also make the pedagogical point explicit:

"Throughout this workshop, we'll intentionally use examples from multiple disciplines rather than relying on a single domain. This helps participants see that open science is not limited to one field and encourages them to adapt the underlying principles to their own research context."
:::
...
**Activity**:
<br>
**What do you think are potential *challenges* to a positive learning environment during an Open Science training event?** 
<br>(*e.g., format, modality, level of experience, audience group size, asynchronous work, technical set-up..*)
<br>
<br>
*Write a few bullet points about this. Save this as part of your developing teaching philosophy for future reference.*
</div>
