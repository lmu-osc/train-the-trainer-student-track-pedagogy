...
::: {.notes}
**Presenter Notes**: Script for the slide here. 
**Instructor Notes**: Base yourself on conceptual change theory and examine exisiting concepts in relation to some key terms. Re-examine formation of new concepts at the end of the lesson. 
:::
...
- **Plan time** for **orientation** at the start and the end:
  - Who is **who**?
  - What is **expected**? 
...
- **Formulate** a broader **vision** and **learning goals**:
  ...
  - How does it all **fit within** the existing context (programme, syllabus..)?
