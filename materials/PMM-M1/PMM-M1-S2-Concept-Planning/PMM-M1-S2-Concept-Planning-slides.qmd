...
:::incremental
- **ORIENTATION**: Provide **orientation** at the start and the end
...
- **JOURNEY AND VISION**: Clearly communicate where learners are headed and the **vision** or **bigger picture**
...
- **LEARNING GOALS**: Clearly communicate the **learning goals**
...
- Make use of **activation methods** for maximizing learning outcomes (*next session!*)
...
:::footer
[https://zenodo.org/records/18905547](https://zenodo.org/records/18905547). See also this [article](https://erinmeyer.com/wp-content/uploads/2023/10/When-Diversity-Meets-Feedback.pdf) by Erin Meyer (The Culture Map).
:::
...
Städeli, C.; Grassi, A.; Rhiner, K.; Obrist, W. (2010): Kompetenzorientiert unterrichten. Das
AVIVA-Modell. Bern: hep.
...
## Praising effort vs. ability: 5 minutes
