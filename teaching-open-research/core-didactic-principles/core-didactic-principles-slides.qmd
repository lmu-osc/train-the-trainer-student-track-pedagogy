...
![](images/getting-started.png){width="15%" fig-align="center" fig-alt="icon of a start button"}
...
![](images/experience-spectrum.png){width="100%" fig-align="center" fig-alt="image of a horizontal axis ranging from no teaching experience to a lot of teaching experience"}
...
![](images/didactics-thoughts-spectrum.png){width="100%" fig-align="center" fig-alt="image of a horizontal axis ranging from not thought about didactics yet to routinely think about didactics"}
...
![](images/QR-code-core-didactic-principles-OSSS26.png){width="80%" fig-align="center" fig-alt="QR code for survey"}
...
Link to survey: [https://partici.fi/30470958](https://partici.fi/30470958)
:::
---
...
d. Mental model of skills acquisition

e. Formulating clear learning objectives
...
d. I am very familiar and have routinely applied this framework in my teaching.
...
![](images/journey.png){width="50%" fig-align="center" fig-alt="Pictogram of journey"}
...
![](images/greek.png){width="20%" fig-align="center" fig-alt="icon of Greek temple ruins"}
...
<div style="background-color: #f0f0f0; padding: 0.1em; border-radius: 5px; font-size: 1em; text-align: center;">
“...is the **science of learning and teaching in general**” <br> (Dolch, 1967)
...
:::footer
@casasolariveraPapelDidacticaProcesos2020; @duitDidaktik2015; Dolch, 1967: @riskulovaTheRoleofDidactics2020
:::

::: {.notes}
**Presenter Notes**: Within the realm of school pedagogics, didactics consists in planning and organizing successful processes of students’ learning. According to Dolch’s (1967) seminal definition, didactics is the science of learning and teaching in general. This definition was later expanded to speficially include teaching and learning strategies connnected to the design adnd formulation of learning contents. 
:::
...
![](images/didactics.png){width="100%" fig-align="center" fig-alt="icon of learning materials: books and pencils"}
...
Here we have an important key point: the instructors choice of content and methods, and what learners learn. You can view didactics as a framework in which knowledge and skills are not passively presented, but understood, retained and applied across in a carefully designed context.
:::
...
![](images/QR-code-core-didactic-principles-OSSS26.png){width="80%" fig-align="center" fig-alt="QR code for particify wordcloud"}

*Scan the QR code and select the item **What is learning?** from the list. Take 2 minutes to brainstorm your thoughts.*

::: {.notes}
**Presenter Notes**: A natural follow-up question from didactics: What is learning to you? How would you define it? What expectations or assumptions come with it? Scan the QR code on the slide and take a few minutes to brainstorm what you connect with this term.
...
As described in Efgivia et al,  learning is an active, learner-centered process, where learners build knowledge internally rather than just simply receiving it from their teachers or instructors. It emphasizes instructors and the active creators of the learning environment in which learning is embedded instead of just being the providers of information. Importantly, what learners bring with them matters, and learning will be influenced by this prior knowledge.
:::
...
::: {.notes}
**Presenter Notes**: The idea that learning is not simply "being transmitted" from an instructor to learners, but more as something that learners actively achieve is captured by constructivism. 
...
![](images/progress.png){width="20%" fig-align="center" fig-alt="icon of green progress arrow"}
...
![](images/obstacles.png){width="20%" fig-align="center" fig-alt="icon of a yellow and black road block representing an obstacle"}
...
**Instructor Notes**: *For the discussion round*: In reviewing the answers to the third question above, you will find that the expert experience amounts to much more than just knowing more facts in your learners. What makes an expert? The answer is that experts have more connections among pieces of knowledge that help them think and problem-solve quickly; more “short-cuts”, if you will.

*Idea for a group activity*: Replace the individual work with work in pairs. Use the think-pair-share method [@mundelseeThinkPairShare2021]: Think for two minutes for yourself, collect your thoughts with a partner for two minutes, then we discuss in the large group for two minutes.
:::
...
![](images/stages-skills-acquisition.png){width="100%" fig-align="center" fig-alt="graphic depicting three persons, each representing a stage of learner: novice, competent practitioner, expert"}
...
![](images/models_learners.png){width="120%" fig-align="center" fig-alt="figure representing the mental models of the three type of learners: novices, competent practitioners, experts"}
...
<tbody>
<tr>
<td><strong>Novice learners</strong></td>
...
<tr>
<td><strong>Competent practitioners</strong></td>
...
2. **Sketch out** the mental model of a novice in comparison to a competent practitioner and/or an expert.
3. **Provide at least two concrete examples** of how the organization of knowledge differs among these types of learners. 
</div>
...
<div style="background-color: #f0f0f0; padding: 0.1em; border-radius: 5px; font-size: 1em; text-align: center;">
Is there something that you are **currently learning how to do**? <br>
Can you identify things that would help you with 
**organizing your mental model** during a workshop? 
</div>
...
:::{.timer #think1 seconds=120 starton=interaction size=40% sound=true}
::: 
...
:::{.timer #pair1 seconds=120 starton=interaction size=40% sound=true}
:::
...
:::{.timer #share1 seconds=120 starton=interaction size=40% sound=true}
:::
...
![](images/picture-in-picture.png){width="100%" fig-align="center" fig-alt="icon of picture in picture"}
...
![](images/constructional-alignment.png){width="100%" fig-align="center" fig-alt="figure depicting the pyramid of constructive alignment, with assessment tasks and teaching activities as separate elements on the bottom layer, and learning objectives as the top layer, all connected through arrows"}
...
::: {.notes}
**Presenter Notes**: For this next exercise, I would like for you to match the assessment type with a given learning objective. We will learn more about learning objectives and how to formulate them later. For now, focus on the alignment aspect: does the learning objective match with the assessment type? Take 8 minutes for this task.
:::
...
::: {.notes}
**Instructor Notes**: Discussion of solutions in the plenum and potential discussions. The solutions are:
- A2
- B3
- C4
- D1
...
![](images/setting-learning-goals-alice.png){width="100%" fig-align="center" fig-alt="quote from conversation between the cat and alice in wonderland about where she has to go from here"}
...
![](images/objectives-hierarchy.png){width="100%" fig-align="center" fig-alt="figure depicting hierarchy of learning objectives, with general objectives at the top layer, then individual objectives as the bottom layers"}
:::
...
![](images/formulating-learning-objectives.png){width="100%" fig-align="center" fig-alt="figure depicing process of formulating learning objectives, starting with knowing the audience, putting an emphasis on the verb, matching the objective to the available timeframe and deriving a metric to measure if learning outcomes were achieved"}
...
It is best to practice this, which we will get to in a later activity.
:::
...
![](images/cognitive-domain.png){width="100%" fig-align="center" fig-alt="pyramid of Blooms taxonomy"}
...
::: {.notes}
**Presenter Notes**: What you see is the pyramid of learning objective verbs by Anderson and Krathwohl [@andersonTaxonomyLearningTeaching2001] who changed the taxonomy from nouns to verbs. It organizes learning objectives into a hierarchy of cognitive processes. It is often shown as a pyramid because it moves from simpler thinking skills at the base to more complex, higher-order thinking at the top.
...
![](images/affective-domain.png){width="100%" fig-align="center" fig-alt="pyramid of levels of affective learning domain"}
...
<!-- For Open Science, it is a little harder to find a good example. Let's take correctly uploading and documenting a dataset using appropriate metadata and licensing.  -->
...
<!-- ::: {.notes} -->
<!-- **Presenter Notes**:  The learning pyramid in the psychomotro domain according to Simpson’s version of the psychomotor domain has the following seven levels: -->
...
<div style="background-color: #f0f0f0; padding: 0.1em; border-radius: 5px; font-size: 0.8em; text-align: center;">
*You are tasked to design a course module on Open Research practices and would like to include a lesson on open access publishing. <br>
...
3. Using Bloom's taxonomy, **formulate two learning objectives** and **assessment methods** that match the content and the teaching activities of the tutorial.  Consider the following: Which level of Bloom's taxonomy are you at and which domain are you targeting?
...
![](images/QR-code-core-didactic-principles-OSSS26.png){width="80%" fig-align="center" fig-alt="QR code"}
...
- [x] Add wordcloud and QR codes
- [x] Add alt text to all figures
- [x] Sort out all references
